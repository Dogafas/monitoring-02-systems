...
2) Какие SLI/SLO предложить для вашей платформы
...
3) Как объяснить менеджеру, зачем нужны технические метрики
...
4) Что показать менеджеру в дашборде
...
5) Что сказать менеджеру простыми словами
